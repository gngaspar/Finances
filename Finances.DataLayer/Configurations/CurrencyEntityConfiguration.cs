namespace Finances.DataLayer.Configurations
{
    ...
    public class CurrencyEntityConfiguration : EntityTypeConfiguration<CurrencyEntity>
    {
        public CurrencyEntityConfiguration()
        {
            ...
            this.Property(p => p.ReasonToOneEuro).IsRequired().HasPrecision(12, 2).HasColumnOrder(2);
            this.Property(p => p.ChangeAt).HasColumnOrder(3);
            this.Property(p => p.CreatedAt).HasColumnOrder(4);
        }
    }
}