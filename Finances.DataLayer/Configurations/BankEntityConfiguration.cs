namespace Finances.DataLayer.Configurations
{
    ...
    public class BankEntityConfiguration : EntityTypeConfiguration<BankEntity>
    {
        public BankEntityConfiguration()
        {
            ...
            this.Property(p => p.Swift).IsRequired().HasMaxLength(50).HasColumnAnnotation(IndexAnnotation.AnnotationName,
                new IndexAnnotation(new IndexAttribute("IX_Swift", 1) { IsUnique = true })).HasColumnOrder(3);
